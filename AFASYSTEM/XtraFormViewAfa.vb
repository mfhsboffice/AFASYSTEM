...
Public Class XtraFormViewAfa
    ...
    Dim tblLog, tblbudgetcontrol As DataTable
    Dim CM As CurrencyManager
    Private Sub XtraFormViewAfa_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        BtnShowhide.Text = "Hide AFA"
        BtnShowhide.Visible = False

        Try
            SplitContainerControl2.SplitterPosition = 900
    ...
    Sub cekattch()
        ...
        If tblLog.Rows.Count > 0 Then
            If Trim(tblLog.Rows(0).Item(1).ToString) = "" Then
                BtnViewAtt1.Enabled = False
            Else
                BtnViewAtt1.Enabled = True
            End If

            If Trim(tblLog.Rows(0).Item(2).ToString) = "" Then
                BtnViewAtt2.Enabled = False
            Else
                BtnViewAtt2.Enabled = True
            End If
        ...
        Try
            If Trim(FormFluMenu.btnuserid.Caption) = "11111" Then
                ...
                If tblOTControl2.Rows.Count = 0 Then
                    btncheckbudget.Visible = False

                Else

                    btncheckbudget.Visible = True
...
left join [dbo].[AFA_SIGNATURE] c on c.AFA_NO=a.AFA_NO and c.TYPE='Budget'  where a.AFA_NO='" & afa & "'")
    ...
    Private Sub btncheckbudget_Click(sender As Object, e As EventArgs) Handles btncheckbudget.Click
        sendemailtoindra()
    End Sub
    ...
    Private Sub BtnViewAtt2_Click(sender As Object, e As EventArgs) Handles BtnViewAtt2.Click

        isiattch2()

    End Sub

    Private Sub BtnViewAtt1_Click(sender As Object, e As EventArgs) Handles BtnViewAtt1.Click
    ...
    Private Sub XtraFormViewAfa_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        Try
            SplitContainerControl2.SplitterPosition = 900
        Catch ex As Exception
    ...
    Private Sub XtraFormViewAfa_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Try
            DocumentViewer1.DocumentSource = Nothing
        Catch ex As Exception
