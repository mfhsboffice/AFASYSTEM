    ...
    Public Sub LoadDocument(ByVal afaNo As String)
        ...
        Try
            ...
            If ds Is Nothing Then
                XtraMessageBox.Show("AFA " & afaNo & " was not found.", "E-Form AFA Disposal",
            ...
            If Convert.ToString(header("AFA_TYPE")) <> "DAA" Then
                XtraMessageBox.Show("AFA " & afaNo & " is not a Disposal type document.",
                                    "E-Form AFA Disposal", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                TextEditAFANo.Text = ""
                Return
            End If
            ...
            If ds.Tables.Count > 2 AndAlso ds.Tables(2).Rows.Count > 0 Then
                ...
                SetComboByValue(SelectAssetFlag, _dtSubType, "CODE", detailRow("SUB_TYPE"))
