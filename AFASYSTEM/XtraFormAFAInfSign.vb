...
Public Class XtraFormAFAInfSign
...
#Region "Form"
    ...
    Private Sub XtraFormAFAInfSign_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetupEditors()
        SetupGrid()
        LoadApproverLists()
        LoadPriority()
...
#Region "Setup"
    ...
    Private Sub LoadPriority()
        ...
        For Each row As DataRow In _dtPriority.Rows
            ComboBoxEdit1.Properties.Items.Add(Convert.ToString(row("NAME")))
        Next
...
#Region "Load"
    ...
    Private Sub LoadAll(ByVal afaNo As String)
        ...
        Try
            ...
            If Convert.ToString(row("AFA_TYPE")) <> "INF" Then
                XtraMessageBox.Show("AFA " & afaNo & " is not an Information document.",
                                    "Signature AFA Information",
                                    MessageBoxButtons.OK, MessageBoxIcon.Warning)
                ClearForm()
                Return
            ...
            TextEditEstimateCost.Text = If(IsDBNull(row("AMT")), "0", Convert.ToString(row("AMT")))
            ...
            ComboBoxEdit1.SelectedIndex = priority
            ...
            Me.Text = "Signature AFA Information - " & _afaNo &
                      " (" & _headerStatus & ")" &
...
#Region "Save"
    Private Sub BtnSave_Click(sender As Object, e As EventArgs) Handles BtnSave.Click
        ...
        If _dtNodes Is Nothing OrElse _dtNodes.Rows.Count = 0 Then
            XtraMessageBox.Show("There are no signature nodes to save.", "Signature AFA Information",
                                MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Return
        End If
        ...
        Try
            ...
            XtraMessageBox.Show("Signature saved.", "Signature AFA Information",
    ...
    Private Sub SavePriority()
        Dim priority As Byte = CByte(Math.Max(0, ComboBoxEdit1.SelectedIndex))
    ...
    Private Sub BtnSend_Click(sender As Object, e As EventArgs) Handles BtnSend.Click
        ...
        Try
            If _signature.Submit(_afaNo, _nik, _pc) Then
                XtraMessageBox.Show(_signature.LastErrorMessage, "Signature AFA Information",
                                    MessageBoxButtons.OK, MessageBoxIcon.Information)
                LoadAll(_afaNo)
            Else
...
#Region "Events"
    ...
    Private Sub GridViewSignature_ShowingEditor(sender As Object, e As System.ComponentModel.CancelEventArgs) _
        ...
        ' once sent, the whole approval tree is fixed
